...
export default function FspGuaranteeSection() {
  return (
    <section
      style={{
    ...
    >
      <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          maxWidth: '580px', margin: '0 auto 2rem auto'
        }}>
          Kami yakin dengan ikhtiar yang kami lakukan. Jika tiada sebarang perubahan selepas rawatan selesai, kami akan kembalikan wang anda — tanpa soal, tanpa syarat rumit.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '4rem', marginBottom: '1rem', lineHeight: 1, filter: 'drop-shadow(0 4px 12px rgba(34,197,94,0.4))' }}>
            🛡️
          </div>

          <div style={{
            display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
            background: '#16A34A', borderRadius: '999px',
            padding: '0.4rem 1.2rem', marginBottom: '1.2rem'
          }}>
          ...
          <p style={{
            fontSize: '1.05rem', color: '#D1FAE5', lineHeight: 1.8,
            maxWidth: '580px', margin: '0 auto 1.5rem auto', fontWeight: 500
          }}>
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{
                  ...
                  background: '#22C55E', color: '#fff', fontWeight: 800, fontSize: '0.75rem',
          ...
          <div style={{
            ...
            <p style={{
              margin: 0, fontSize: '0.82rem', color: '#FEF3C7', lineHeight: 1.7, fontStyle: 'italic'
            }}>
        ...
        <p style={{ fontSize: '0.85rem', color: '#6EE7B7', lineHeight: 1.7, fontStyle: 'italic' }}>
