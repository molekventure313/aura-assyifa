  ...
  return (
    ...
    >
      <div style={{ maxWidth: '850px', margin: '0 auto' }}>
        ...
        >
          Aura Assyifa menawarkan ikhtiar rawatan secara patuh syariah bagi menangani gangguan mistik. Ramai pesakit berkongsi bahawa mereka berasa lebih tenang, lebih mudah beribadah dan dapat menjalani kehidupan harian dengan lebih baik selepas menjalani rawatan.
        </p>
        ...
        <div style={{ marginBottom: '2.5rem', borderRadius: '12px', overflow: 'hidden', border: '3px solid #FDE047', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
          <img 
            ...
            alt="Gambar Hero Aura Assyifa Ikhtiar Rawatan Sihir" 
