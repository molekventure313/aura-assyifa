...
export default function MatlamatSection() {
  const goals = [
    'Membantu mengenal pasti dan memutuskan ikatan saka dalam keluarga.',
    'Memulihkan kesihatan ahli keluarga yang terjejas akibat gangguan saka.',
    'Mengembalikan keharmonian dan perpaduan dalam keluarga.',
    'Membuka semula pintu rezeki keluarga yang lama tersekat.',
    'Memberikan panduan perlindungan agar generasi seterusnya terpelihara.'
  ];
    ...
    >
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.4rem', marginBottom: '2rem', letterSpacing: '-0.02em' }}>
          Apa Yang Ingin Dicapai Melalui Rawatan Saka Aura Assyifa?
        </h2>
