...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    {
      q: 'Berapa lama proses rawatan gangguan mistik?',
      a: 'Berbeza-beza mengikut individu dan jenis gangguan. Ada yang merasai perubahan selepas satu sesi, ada yang memerlukan rawatan berterusan.'
    },
    {
      q: 'Adakah keluarga perlu terlibat dalam proses rawatan?',
      a: 'Tidak semestinya. Rawatan boleh dilakukan secara individu. Namun sokongan keluarga sering membantu proses pemulihan menjadi lebih cepat.'
    },
    {
      q: 'Apakah yang akan berlaku selepas sesi rawatan?',
      a: 'Perawat akan memberikan panduan amalan harian dan arahan susulan untuk memastikan gangguan tidak berulang.'
    }
  ];
