...
export default function MatlamatSection() {
  const goals = [
    'Membantu mengenal pasti jenis dan punca gangguan mistik yang dialami.',
    'Mengurangkan dan seterusnya menghapuskan gangguan yang dirasai.',
    'Memulihkan keupayaan untuk beribadah dengan khusyuk dan tenang.',
    'Mengembalikan keseimbangan emosi dan kesihatan mental.',
    'Memberikan panduan perlindungan diri dan keluarga daripada gangguan pada masa hadapan.'
  ];
    ...
    >
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.4rem', marginBottom: '2rem', letterSpacing: '-0.02em' }}>
          Apa Yang Akan Dicapai Melalui Rawatan Gangguan Mistik Aura Assyifa?
        </h2>
