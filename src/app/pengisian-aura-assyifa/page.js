...
const LAYERS = [
  ...
  { num: 'IV', accent: '#93C5FD', title: 'Ayat-Ayat Kesembuhan', desc: 'Memulihkan kesan-kesan gangguan yang masih tinggal dalam badan. Membantu proses penyembuhan spiritual dan fizikal secara berterusan.' },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0D1A3A', fontFamily: "'Inter', -apple-system, sans-serif", color: '#FFF' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, #070D20 0%, #080F2E 50%, #0D1A3A 100%)', padding: '5rem 1rem 4rem', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative', zIndex: 1, animation: 'fadeInUp 0.8s ease both' }}>
          ...
          <h1 className="hero-h1" style={{ fontSize: 'clamp(1.9rem, 4.5vw, 3rem)', fontWeight: 900, color: '#FEF3C7', lineHeight: 1.18, letterSpacing: '-0.03em', marginBottom: '1.25rem' }}>
            Ingatkan Dah Sihat…{' '}
            <span style={{ color: '#FDE047', textShadow: '0 0 30px rgba(253,224,71,0.3)' }}>Tapi Gangguan Datang Balik?</span>
          </h1>

          <p style={{ fontSize: '1.05rem', color: '#BFDBFE', lineHeight: 1.75, maxWidth: '620px', margin: '0 auto 1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.6rem', marginBottom: '2.5rem' }}>
            {['Jarak Jauh — Tanpa Pos', '100% Patuh Syariah', 'Pelarasan Setiap Minggu', 'Siap Dalam 7 Hari'].map(t => (
              <span key={t} style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', color: '#BFDBFE', fontSize: '0.82rem', fontWeight: 600, padding: '0.35rem 1rem', borderRadius: '999px', letterSpacing: '0.01em' }}>{t}</span>
            ))}
          </div>

          {/* Hero medallion */}
          <div style={{ width: '140px', height: '140px', borderRadius: '50%', background: 'radial-gradient(circle at 35% 35%, #0D1A3A, #070D20)', border: '2px solid rgba(253,224,71,0.6)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '0 auto 2.5rem', animation: 'pulseGlow 3s ease-in-out infinite', boxShadow: '0 0 0 8px rgba(253,224,71,0.05)' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'linear-gradient(135deg, #FDE047, #F59E0B)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.4rem', boxShadow: '0 4px 16px rgba(253,224,71,0.4)' }}>
              <svg width="26" height="26" viewBox="0 0 24 24" fill="#0D1A3A">
      ...
      <section style={{ position: 'relative', background: '#FFFFFF', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '980px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', alignItems: 'start' }}>
            {TESTI1.map((src, i) => (
              <div key={i} className="testi-img anim-card" style={{ borderRadius: '16px', overflow: 'hidden', border: '2px solid #0D1A3A', boxShadow: '0 8px 25px rgba(0,0,0,0.08)', background: '#F8FAFC', transitionDelay: `${i * 0.1}s` }}>
          ...
          <div style={{ marginTop: '2.5rem', display: 'flex', justifyContent: 'center', gap: '3rem', flexWrap: 'wrap' }}>
            {[{ target: 500, suffix: '+', label: 'Pesakit Dirawat' }, { target: 98, suffix: '%', label: 'Puas Hati' }, { target: 100, suffix: '%', label: 'Patuh Syariah' }].map(({ target, suffix, label }) => (
              <div key={label} style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 'clamp(2rem, 5vw, 2.8rem)', fontWeight: 900, color: '#0D1A3A', lineHeight: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', textAlign: 'left' }}>
            {PROBLEMS.map((p, i) => (
              <div key={p.num} className="anim-card" style={{ background: 'linear-gradient(135deg, #070D20 0%, #0D1A3A 100%)', border: '1px solid rgba(253,224,71,0.2)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 8px 24px rgba(0,0,0,0.3)', transitionDelay: `${i * 0.08}s` }}>
                ...
                <p style={{ margin: 0, fontSize: '0.84rem', color: '#EFF6FF', lineHeight: 1.65, opacity: 0.9 }}>{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <div style={{ backdropFilter: 'blur(8px)', background: 'rgba(253,224,71,0.06)', border: '1px solid rgba(253,224,71,0.3)', borderLeft: '4px solid #FDE047', borderRadius: '14px', padding: '1.5rem 1.75rem', display: 'flex', gap: '1rem', alignItems: 'flex-start', textAlign: 'left' }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '0.85rem', color: '#BFDBFE', lineHeight: 1.75 }}>Dengan Pengisian Aura Assyifa pada barang anda, anda tidak perlu bergantung pada perawat untuk setiap serangan. Rawat sendiri, bila-bila masa, di mana sahaja — tanpa had.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ position: 'relative', background: '#0D1A3A', padding: '4.5rem 1rem', textAlign: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '920px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(253,224,71,0.2)', borderRadius: '14px', padding: '1.4rem 1.6rem', textAlign: 'left', display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
            ...
            <p style={{ margin: 0, fontSize: '0.88rem', color: '#EFF6FF', lineHeight: 1.7 }}>
      ...
      <section style={{ position: 'relative', background: '#F8FAFC', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#4B5563', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 1rem' }}>
            ...
            <strong style={{ color: '#0D1A3A' }}>setiap kali diserang, rawat terus.</strong>
          </p>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', background: 'linear-gradient(135deg, #070D20 0%, #0D1A3A 100%)', border: '2px solid #FDE047', borderRadius: '16px', padding: '1rem 2rem', marginBottom: '3rem', boxShadow: '0 8px 32px rgba(13,27,74,0.3)' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.78rem', color: '#BFDBFE', fontWeight: 600 }}>Ruqyah Syar&apos;iyyah · 4 Lapisan Ayat · Pelarasan Mingguan</div>
            </div>
          </div>

          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#0D1A3A', textTransform: 'uppercase', letterSpacing: '0.1em' }}>10 Kelebihan Utama</span>
            <h3 style={{ fontSize: 'clamp(1.2rem, 3vw, 1.7rem)', fontWeight: 800, color: '#0D1A3A', marginTop: '0.4rem', marginBottom: '0.5rem' }}>Kenapa Pengisian Aura Assyifa Berbeza Dari Yang Lain?</h3>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem', textAlign: 'left' }}>
            {BENEFITS.map((b, i) => (
              <div key={b.num} className="anim-card" style={{ background: '#FFFFFF', border: '1.5px solid #E2E8F0', borderRadius: '14px', padding: '1.25rem', display: 'flex', gap: '0.85rem', alignItems: 'flex-start', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', transitionDelay: `${i * 0.05}s` }}>
                <span style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'linear-gradient(135deg, #EFF6FF, #EFF6FF)', border: '1px solid #BFDBFE', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', fontWeight: 900, color: '#0D1A3A', flexShrink: 0 }}>{b.num}</span>
                <div>
                  <p style={{ margin: '0 0 0.2rem', fontWeight: 800, fontSize: '0.88rem', color: '#0D1A3A' }}>{b.title}</p>
        ...
        <div style={{ maxWidth: '920px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
            {LAYERS.map((l, i) => (
              <div key={l.num} className="anim-card" style={{ background: '#0D1A3A', border: `2px solid ${l.accent}33`, borderRadius: '60px 60px 16px 16px', padding: '1.75rem 1.5rem 1.5rem', boxShadow: `0 8px 24px rgba(0,0,0,0.3), inset 0 0 0 1px ${l.accent}11`, transitionDelay: `${i * 0.12}s` }}>
                ...
                <p style={{ margin: 0, fontSize: '0.875rem', color: '#EFF6FF', lineHeight: 1.65, opacity: 0.9 }}>{l.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ background: 'linear-gradient(135deg, #070D20 0%, #0D1A3A 100%)', border: '2px solid rgba(59,130,246,0.4)', borderRadius: '18px', padding: '1.75rem', boxShadow: '0 0 40px rgba(59,130,246,0.15)', display: 'flex', alignItems: 'flex-start', gap: '1.25rem', textAlign: 'left' }} className="anim-card">
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#EFF6FF', fontSize: '0.92rem', lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
            {CHANGES.map((c, i) => (
              <div key={c.num} className="anim-card" style={{ background: '#FFFFFF', border: '2px solid rgba(253,224,71,0.3)', borderRadius: '14px', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'flex-start', gap: '1rem', boxShadow: '0 4px 16px rgba(0,0,0,0.15)', transitionDelay: `${i * 0.1}s` }}>
                ...
                <div>
                  <p style={{ margin: '0 0 0.25rem', fontWeight: 800, fontSize: '0.97rem', color: '#0D1A3A' }}>{c.title}</p>
      ...
      <section style={{ position: 'relative', background: '#0D1A3A', padding: '4.5rem 1rem', textAlign: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '980px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <p style={{ marginTop: '2rem', fontSize: '0.88rem', color: '#BFDBFE', fontStyle: 'italic', lineHeight: 1.6, opacity: 0.8 }}>Semua testimoni di atas adalah daripada pesakit sebenar yang telah mendapatkan rawatan Aura Assyifa. Alhamdulillah — semoga Allah terus permudahkan urusan mereka.</p>
        </div>
      </section>
            ...
            <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
              {[
                ...
                <div key={item} className="check-row">
                  <span style={{ fontSize: '0.875rem', color: '#EFF6FF', lineHeight: 1.5 }}>{item}</span>
                </div>
              ))}
            </div>
      ...
      <section style={{ position: 'relative', background: '#070D20', padding: '5rem 1rem', textAlign: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', position: 'relative', zIndex: 1 }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#BFDBFE', lineHeight: 1.7, marginBottom: '2.5rem', opacity: 0.9 }}>
