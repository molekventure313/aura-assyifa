    ...
    <main style={{ minHeight: '100vh', background: '#070D20', fontFamily: "'Inter', -apple-system, sans-serif", color: '#FFF' }} className="islamic-pattern-bg">
      ...
      <section style={{ background: 'linear-gradient(180deg, #0B1528 0%, #050B1A 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto' }} className="anim-section">
          <span style={{ display: 'inline-block', fontSize: '0.72rem', fontWeight: 800, color: '#F87171', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem', background: 'rgba(248,113,113,0.1)', padding: '0.35rem 1.2rem', borderRadius: '50px', border: '1px solid rgba(248,113,113,0.3)' }}>
            Peringatan Penting
          </span>
          <h2 className="font-serif-title" style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.3rem)', fontWeight: 800, color: '#FEF3C7', marginTop: '0.5rem', marginBottom: '0.75rem', lineHeight: 1.3 }}>
            ...
            {DANGERS.map((d, i) => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
                  <span style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'rgba(248,113,113,0.15)', border: '1px solid rgba(248,113,113,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', fontWeight: 900, color: '#FCA5A5', flexShrink: 0 }}>
                    {d.num}
                  </span>
                  <h3 style={{ margin: 0, fontSize: '0.92rem', fontWeight: 800, color: '#FCA5A5', lineHeight: 1.3 }}>{d.title}</h3>
                </div>
                <p style={{ margin: 0, fontSize: '0.84rem', color: '#FEF3C7', lineHeight: 1.65, opacity: 0.88 }}>{d.desc}</p>
              </div>
            ))}
          </div>
