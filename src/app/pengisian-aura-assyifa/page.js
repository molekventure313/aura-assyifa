...
export default function PengisianAuraAssyifaPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0D1B4A', fontFamily: "'Inter', -apple-system, sans-serif", color: '#FFF' }}>
      ...
      {/* ══════════════════════════════════════
          HERO
      ══════════════════════════════════════ */}
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, #050818 0%, #080F2E 50%, #0D1B4A 100%)', padding: '5rem 1rem 4rem', textAlign: 'center' }}>
        {/* Ambient orbs */}
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative', animation: 'fadeInUp 0.8s ease both' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: '#BAE6FD', lineHeight: 1.75, maxWidth: '620px', margin: '0 auto 1.5rem' }}>
          ...
          <div style={{ backdropFilter: 'blur(12px)', background: 'rgba(253,224,71,0.06)', border: '1.5px solid rgba(253,224,71,0.35)', borderRadius: '20px', padding: '1.5rem 2rem', maxWidth: '600px', margin: '0 auto 2rem', textAlign: 'left', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
            ...
            <p style={{ margin: 0, fontSize: '1.02rem', color: '#FEF3C7', lineHeight: 1.65, fontWeight: 600 }}>
              ...
              <span style={{ color: '#60A5FA' }}>Rawat sendiri, tanpa had, seumur hidup.</span>
            </p>
          </div>
          ...
          {/* Hero medallion */}
          <div style={{ width: '140px', height: '140px', borderRadius: '50%', background: 'radial-gradient(circle at 35% 35%, #1A3A8F, #050818)', border: '2px solid rgba(253,224,71,0.6)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '0 auto 2.5rem', animation: 'pulseGlow 3s ease-in-out infinite', boxShadow: '0 0 0 8px rgba(253,224,71,0.05)' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'linear-gradient(135deg, #FDE047, #F59E0B)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.4rem', boxShadow: '0 4px 16px rgba(253,224,71,0.4)' }}>
              <svg width="26" height="26" viewBox="0 0 24 24" fill="#0D1B4A">
          ...
          <p style={{ marginTop: '0.85rem', fontSize: '0.8rem', color: '#93C5FD', fontStyle: 'italic', opacity: 0.8 }}>Hubungi via WhatsApp · 100% Patuh Syariah</p>
        </div>
      </section>
      ...
      <section style={{ background: '#FFFFFF', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto' }} className="anim-section">
          <span style={{ display: 'inline-block', fontSize: '0.72rem', fontWeight: 800, color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem', background: 'rgba(59,130,246,0.08)', padding: '0.3rem 1rem', borderRadius: '50px', border: '1px solid rgba(59,130,246,0.2)' }}>Testimoni Pesakit — Bahagian 1</span>
          ...
          <div style={{ marginTop: '2.5rem', display: 'flex', justifyContent: 'center', gap: '3rem', flexWrap: 'wrap' }}>
            {[{ target: 500, suffix: '+', label: 'Pesakit Dirawat' }, { target: 98, suffix: '%', label: 'Puas Hati' }, { target: 100, suffix: '%', label: 'Patuh Syariah' }].map(({ target, suffix, label }) => (
              <div key={label} style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 'clamp(2rem, 5vw, 2.8rem)', fontWeight: 900, color: '#1D4ED8', lineHeight: 1 }}>
      ...
      ══════════════════════════════════════ */}
      <section style={{ background: '#0F1F52', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', textAlign: 'left' }}>
            {PROBLEMS.map((p, i) => (
              <div key={p.num} className="anim-card" style={{ background: 'linear-gradient(135deg, #0F2776 0%, #1A3A8F 100%)', border: '1px solid rgba(253,224,71,0.15)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(0,0,0,0.2)', transitionDelay: `${i * 0.08}s` }}>
                ...
                <p style={{ margin: 0, fontSize: '0.84rem', color: '#DBEAFE', lineHeight: 1.65, opacity: 0.9 }}>{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          ...
          <div style={{ backdropFilter: 'blur(8px)', background: 'rgba(253,224,71,0.06)', border: '1px solid rgba(253,224,71,0.3)', borderLeft: '4px solid #FDE047', borderRadius: '14px', padding: '1.5rem 1.75rem', display: 'flex', gap: '1rem', alignItems: 'flex-start', textAlign: 'left' }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '0.85rem', color: '#BAE6FD', lineHeight: 1.75 }}>Dengan Pengisian Aura Assyifa pada barang anda, anda tidak perlu bergantung pada perawat untuk setiap serangan. Rawat sendiri, bila-bila masa, di mana sahaja — tanpa had.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ══════════════════════════════════════
          DALIL ISLAM
      ══════════════════════════════════════ */}
      <section style={{ background: '#0D1B4A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.65, maxWidth: '700px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Konsep &quot;pengisian&quot; adalah amalan yang diiktiraf dalam tradisi Islam. Qias kepada bacaan pada air, minyak dan kain yang disebutkan dalam kitab-kitab ulama silam.</p>
          ...
          <div style={{ background: 'rgba(96,165,250,0.06)', border: '1.5px solid rgba(96,165,250,0.2)', borderRadius: '14px', padding: '1.5rem 1.8rem', marginBottom: '1.5rem' }} className="anim-card">
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(253,224,71,0.15)', borderRadius: '14px', padding: '1.4rem 1.6rem', textAlign: 'left', display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
            ...
            <p style={{ margin: 0, fontSize: '0.88rem', color: '#DBEAFE', lineHeight: 1.7 }}>
      ...
      <section style={{ background: '#F8FAFC', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          <span style={{ display: 'inline-block', fontSize: '0.72rem', fontWeight: 800, color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem', background: 'rgba(59,130,246,0.08)', padding: '0.3rem 1rem', borderRadius: '50px', border: '1px solid rgba(59,130,246,0.2)' }}>Penyelesaian</span>
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#0D1B4A', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Pengisian Aura Assyifa — Perawat Private Anda Yang Sentiasa Bersama</h2>
          <p style={{ fontSize: '1rem', color: '#4B5563', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 1rem' }}>
            ...
            <strong style={{ color: '#1D4ED8' }}>setiap kali diserang, rawat terus.</strong>
          </p>

          {/* Product badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', background: 'linear-gradient(135deg, #0D1B4A 0%, #1A3A8F 100%)', border: '2px solid #FDE047', borderRadius: '16px', padding: '1rem 2rem', marginBottom: '3rem', boxShadow: '0 8px 32px rgba(13,27,74,0.3)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'linear-gradient(135deg, #FDE047, #F59E0B)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="#0D1B4A"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
            </div>
            <div style={{ textAlign: 'left' }}>
              <div style={{ fontSize: '1.05rem', fontWeight: 900, color: '#FDE047' }}>Pengisian Aura Assyifa</div>
              <div style={{ fontSize: '0.78rem', color: '#BAE6FD', fontWeight: 600 }}>Ruqyah Syar&apos;iyyah · 4 Lapisan Ayat · Pelarasan Mingguan</div>
            </div>
          </div>

          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.1em' }}>10 Kelebihan Utama</span>
            <h3 style={{ fontSize: 'clamp(1.2rem, 3vw, 1.7rem)', fontWeight: 800, color: '#0D1B4A', marginTop: '0.4rem', marginBottom: '0.5rem' }}>Kenapa Pengisian Aura Assyifa Berbeza Dari Yang Lain?</h3>
          </div>
      ...
      {/* ══════════════════════════════════════
          4 LAYERS
      ══════════════════════════════════════ */}
      <section style={{ background: '#090F30', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.7, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Setiap barang diisi dengan 4 lapisan ayat ruqyah syar&apos;iyyah yang berbeza fungsi. Gabungan yang direka untuk merawat, membakar, membatal dan membentengi secara serentak.</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
            {LAYERS.map((l, i) => (
              <div key={l.num} className="anim-card" style={{ background: '#0D1B4A', border: `2px solid ${l.accent}33`, borderRadius: '16px', padding: '1.75rem', boxShadow: `0 8px 24px rgba(0,0,0,0.3), inset 0 0 0 1px ${l.accent}11`, transitionDelay: `${i * 0.12}s` }}>
                ...
                <p style={{ margin: 0, fontSize: '0.875rem', color: '#DBEAFE', lineHeight: 1.65, opacity: 0.9 }}>{l.desc}</p>
              </div>
            ))}
          </div>
          {/* Weekly recalibration callout */}
          <div style={{ background: 'linear-gradient(135deg, #1A3A8F 0%, #1D4ED8 100%)', border: '2px solid rgba(59,130,246,0.4)', borderRadius: '18px', padding: '1.75rem', boxShadow: '0 0 40px rgba(59,130,246,0.15)', display: 'flex', alignItems: 'flex-start', gap: '1.25rem', textAlign: 'left' }} className="anim-card">
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#DBEAFE', fontSize: '0.92rem', lineHeight: 1.7 }}>
      ...
      <section style={{ background: '#0D1B4A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.65, maxWidth: '600px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Bukan janji kosong — ini berdasarkan pengalaman pesakit yang dah ada Pengisian Aura Assyifa.</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
            {CHANGES.map((c, i) => (
              <div key={c.num} className="anim-card" style={{ background: '#FFFFFF', border: '2px solid rgba(253,224,71,0.3)', borderRadius: '14px', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'flex-start', gap: '1rem', boxShadow: '0 4px 16px rgba(0,0,0,0.15)', transitionDelay: `${i * 0.1}s` }}>
                <div style={{ width: '44px', height: '44px', borderRadius: '12px', background: 'linear-gradient(135deg, #0D1B4A, #1A3A8F)', border: '1.5px solid rgba(253,224,71,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ fontSize: '0.7rem', fontWeight: 900, color: '#FDE047' }}>{c.num}</span>
                </div>
                <div>
                  <p style={{ margin: '0 0 0.25rem', fontWeight: 800, fontSize: '0.97rem', color: '#0D1B4A' }}>{c.title}</p>
      ...
      <section style={{ background: '#0F1F52', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto' }} className="anim-section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', alignItems: 'start' }}>
            {TESTI2.map((src, i) => (
              <div key={i} className="testi-img anim-card" style={{ borderRadius: '16px', overflow: 'hidden', border: '2px solid rgba(253,224,71,0.4)', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', background: '#0D1B4A', transitionDelay: `${i * 0.12}s` }}>
                <img src={src} alt={`Testimoni Pesakit Aura Assyifa ${i + 4}`} style={{ width: '100%', height: 'auto', display: 'block' }} />
              </div>
            ))}
          </div>
          <p style={{ marginTop: '2rem', fontSize: '0.88rem', color: '#BAE6FD', fontStyle: 'italic', lineHeight: 1.6, opacity: 0.8 }}>Semua testimoni di atas adalah daripada pesakit sebenar yang telah mendapatkan rawatan Aura Assyifa. Alhamdulillah — semoga Allah terus permudahkan urusan mereka.</p>
        </div>
      </section>
      ...
      <section style={{ background: '#090F30', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Tiga pilihan — tapi hanya satu yang memberikan perlindungan <strong style={{ color: '#FDE047' }}>berterusan tanpa had</strong>.</p>
              ...
              <tbody>
                {COMPARE_ROWS.map((row, i) => (
                  <tr key={row.label} style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.02)' : 'transparent' }}>
                    ...
                    <td style={{ padding: '0.85rem 0.5rem', textAlign: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)' }}><span style={{ color: row.air ? '#60A5FA' : '#EF4444', fontSize: '1rem', fontWeight: 700 }}>{row.air ? '✓' : '✗'}</span></td>
                    <td style={{ padding: '0.85rem 0.5rem', textAlign: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)' }}><span style={{ color: row.rawatan ? '#60A5FA' : '#EF4444', fontSize: '1rem', fontWeight: 700 }}>{row.rawatan ? '✓' : '✗'}</span></td>
                    <td style={{ padding: '0.85rem 0.5rem', textAlign: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(253,224,71,0.04)' }}><span style={{ color: '#60A5FA', fontSize: '1rem', fontWeight: 700 }}>✓</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* ══════════════════════════════════════
          PRICING + FAQ
      ══════════════════════════════════════ */}
      <section id="borang" style={{ background: 'linear-gradient(160deg, #0D1B4A 0%, #080F2E 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#DBEAFE', lineHeight: 1.65, maxWidth: '560px', margin: '0 auto 2rem', opacity: 0.9 }}>Satu pelaburan untuk perlindungan seumur hidup. Pelarasan mingguan percuma selama-lamanya.</p>

          {/* Price card */}
          <div style={{ background: 'linear-gradient(160deg, #090F30 0%, #0D1B4A 100%)', border: '2px solid rgba(253,224,71,0.4)', borderRadius: '24px', padding: '2.5rem 2rem', marginBottom: '2rem', boxShadow: '0 24px 60px rgba(0,0,0,0.5), 0 0 60px rgba(253,224,71,0.06)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ fontSize: '0.88rem', color: '#BAE6FD', marginBottom: '2rem', opacity: 0.85 }}>Bayar Sekali · Guna Seumur Hidup</div>
            ...
            <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
              {[
                ...
                <div key={item} className="check-row">
                  <span style={{ fontSize: '0.875rem', color: '#DBEAFE', lineHeight: 1.5 }}>{item}</span>
                </div>
              ))}
            </div>

            <WAButton id="cta-borang" label="Hubungi Kami — Tempah Sekarang" />
            <p style={{ marginTop: '0.85rem', fontSize: '0.78rem', color: '#93C5FD', fontStyle: 'italic', opacity: 0.8 }}>Hubungi via WhatsApp · 100% Patuh Syariah</p>
          </div>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            {[
              ...
              <div key={faq.q} className="anim-card" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(253,224,71,0.12)', borderRadius: '12px', padding: '1.1rem 1.25rem', marginBottom: '0.75rem', transitionDelay: `${i * 0.08}s` }}>
                ...
                <p style={{ margin: 0, color: '#DBEAFE', fontSize: '0.84rem', lineHeight: 1.65, opacity: 0.9 }}>J: {faq.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════
          CLOSING CTA
      ══════════════════════════════════════ */}
      <section style={{ background: '#050818', padding: '5rem 1rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', position: 'relative' }} className="anim-section">
          ...
          <p style={{ fontSize: '1rem', color: '#BAE6FD', lineHeight: 1.7, marginBottom: '2.5rem', opacity: 0.9 }}>
