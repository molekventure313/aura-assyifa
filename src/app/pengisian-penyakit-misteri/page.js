...
const LAYERS = [
  ...
  { num: 'II', accent: '#F59E0B', title: 'Ayat Khusus Pembatal Santau & Penyakit Misteri', desc: 'Membatalkan dan membuang kesan santau, sihir penyakit, atau sebarang gangguan rohani yang telah bertapak dalam badan dan menyebabkan kesakitan.' },
  ...
  { num: 'IV', accent: '#34D399', title: 'Ayat-Ayat Penyembuhan & Pemulihan Fizikal', desc: 'Memulihkan sel-sel dan organ dalam badan yang telah terjejas akibat gangguan rohani — membantu proses penyembuhan secara fizikal dan spiritual.' },
];
    ...
    <main style={{ minHeight: '100vh', background: '#042E23', fontFamily: "'Inter', -apple-system, sans-serif", color: '#FFF' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, #010E09 0%, #021812 50%, #042E23 100%)', padding: '5rem 1rem 4rem', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative', animation: 'fadeInUp 0.8s ease both' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(253,224,71,0.1)', border: '1px solid rgba(253,224,71,0.4)', padding: '0.4rem 1.2rem', borderRadius: '50px', marginBottom: '1.5rem', fontSize: '0.75rem', fontWeight: 800, color: '#FDE047', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
            Aura Assyifa · Pengisian Khusus Penyakit Misteri
          </div>
          ...
          <p style={{ fontSize: '1.05rem', color: '#A7F3D0', lineHeight: 1.75, maxWidth: '640px', margin: '0 auto 1.75rem' }}>
            ...
            <strong style={{ color: '#FEF3C7' }}>Ini bukan khayalan — ini realiti yang ramai pesakit hadapi.</strong>
          </p>

          {/* Checklist glassmorphism box */}
          <div style={{ backdropFilter: 'blur(12px)', background: 'rgba(253,224,71,0.05)', border: '1.5px solid rgba(253,224,71,0.25)', borderRadius: '20px', padding: '1.5rem 2rem', maxWidth: '620px', margin: '0 auto 2rem', textAlign: 'left', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
            <div style={{ fontSize: '0.7rem', fontWeight: 800, color: '#FDE047', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '0.9rem' }}>Tanda-Tanda Penyakit Misteri Berkaitan Rohani</div>
          ...
          <div style={{ width: '140px', height: '140px', borderRadius: '50%', background: 'radial-gradient(circle at 35% 35%, #065F46, #010E09)', border: '2px solid rgba(253,224,71,0.6)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '0 auto 2.5rem', animation: 'pulseGlow 3s ease-in-out infinite', boxShadow: '0 0 0 8px rgba(253,224,71,0.05)' }}>
            ...
            <span style={{ fontSize: '0.46rem', color: '#FDE047', fontWeight: 800, letterSpacing: '0.06em', textAlign: 'center', lineHeight: 1.4 }}>PENGISIAN<br />RAWATAN<br />PENYAKIT<br />MISTERI</span>
          </div>
      ...
      <section style={{ background: '#042E23', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          <span style={{ display: 'inline-block', fontSize: '0.72rem', fontWeight: 800, color: '#FDE047', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem', background: 'rgba(253,224,71,0.1)', padding: '0.3rem 1rem', borderRadius: '50px', border: '1px solid rgba(253,224,71,0.3)' }}>Tanda-Tanda Penyakit Misteri</span>
          ...
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>
            ...
            <strong style={{ color: '#FDE047' }}>Jika anda mengalami lebih dari 3 perkara ini</strong> — kemungkinan besar punca penyakit anda adalah rohani.
          </p>
      ...
      <section style={{ background: 'linear-gradient(160deg, #0B1A0F 0%, #031208 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Kenapa Pesakit Penyakit Misteri Perlu Pengisian — Bukan Sekadar Rawatan Sekali?</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>
            Rawatan sekali mungkin melegakan. Tapi tanpa perlindungan yang aktif berterusan —{' '}
            <strong style={{ color: '#FDE047' }}>gangguan rohani boleh kembali menyerang pada bila-bila masa.</strong>
          </p>
      ...
      <section style={{ background: '#042E23', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Rawatan Penyakit Melalui Al-Quran — Perintah &amp; Janji Allah</h2>
      ...
      <section style={{ background: '#F8FAFC', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#042E23', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Apa Yang Ingin Dicapai Melalui Pengisian Rawatan Penyakit Misteri Aura Assyifa?</h2>
          <p style={{ fontSize: '1rem', color: '#4B5563', lineHeight: 1.65, marginBottom: '2.5rem' }}>Pengisian ini dirangka khusus untuk memulihkan kesihatan fizikal dan rohani anda dari punca penyakit misteri secara tuntas dan patuh syariah.</p>
      ...
      <section style={{ background: '#031E17', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>4 Lapisan Ayat Ruqyah Khusus Penyakit Misteri</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.7, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Setiap barang diisi dengan 4 lapisan ayat ruqyah syar&apos;iyyah yang berbeza fungsi — direka khusus untuk merawat penyakit misteri yang berpunca rohani secara menyeluruh.</p>
          ...
          <div style={{ background: 'linear-gradient(135deg, #065F46 0%, #047857 100%)', border: '2px solid rgba(16,185,129,0.4)', borderRadius: '18px', padding: '1.75rem', display: 'flex', alignItems: 'flex-start', gap: '1.25rem', textAlign: 'left' }} className="anim-card">
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#D1FAE5', fontSize: '0.92rem', lineHeight: 1.7 }}>Perawat Aura Assyifa akan buat <strong style={{ color: '#FDE047' }}>pelarasan dan pengisian semula setiap minggu secara automatik</strong> — memastikan kekuatan ayat ruqyah sentiasa aktif untuk terus melawan punca penyakit misteri anda.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#0B382D', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.5rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Betulkah Aura Assyifa Berkesan Untuk Selesaikan Penyakit Misteri?</h2>
      ...
      <section id="borang" style={{ background: 'linear-gradient(160deg, #042E23 0%, #021812 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Dapatkan Pengisian Rawatan Penyakit Misteri Aura Assyifa</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '560px', margin: '0 auto 2rem', opacity: 0.9 }}>Satu pelaburan untuk perlindungan dan rawatan berterusan. Pelarasan mingguan percuma selama-lamanya.</p>
          ...
          <div style={{ background: 'linear-gradient(160deg, #031E17 0%, #042E23 100%)', border: '2px solid rgba(253,224,71,0.4)', borderRadius: '24px', padding: '2.5rem 2rem', marginBottom: '2rem', boxShadow: '0 24px 60px rgba(0,0,0,0.5), 0 0 60px rgba(253,224,71,0.06)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ fontSize: '0.72rem', fontWeight: 800, color: '#FDE047', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.75rem' }}>Pengisian Rawatan Penyakit Misteri Aura Assyifa</div>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            {[
              { q: 'Adakah ini sesuai jika ujian perubatan saya semua normal?', a: 'Ya, itulah tanda paling kuat bahawa punca penyakit adalah rohani. Pengisian Rawatan Penyakit Misteri ini direka khusus untuk kes yang perubatan biasa tidak dapat kesan puncanya.' },
              ...
              { q: 'Berapa lama sebelum saya rasa perubahan?', a: 'Kebanyakan pesakit mula merasakan perubahan dalam tempoh 7-14 hari pertama. Proses penyembuhan berbeza-beza bergantung kepada keparahan gangguan.' },
      ...
      <section style={{ background: '#010E09', padding: '5rem 1rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', position: 'relative' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2rem)', fontWeight: 800, color: '#FDE047', letterSpacing: '-0.02em', lineHeight: 1.3, margin: '2rem 0 1rem' }}>
            Jangan biarkan penyakit misteri terus memusnahkan kesihatan dan kualiti hidup anda.
          </h2>
          <p style={{ fontSize: '1rem', color: '#A7F3D0', lineHeight: 1.7, marginBottom: '2.5rem', opacity: 0.9 }}>
            Ramai pesakit yang pernah berada di tempat anda kini kembali sihat, bertenaga dan boleh menjalani kehidupan harian dengan tenang selepas mendapat rawatan dari Aura Assyifa. Ambil langkah pertama hari ini.
          </p>
          <WAButton id="cta-closing" label="Hubungi Kami — Mula Rawatan Sekarang" />
