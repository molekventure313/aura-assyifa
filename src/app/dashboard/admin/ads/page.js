                                  ...
                                  <tbody>
                                    {rec.breakdown.map((b) => (
                                      <tr key={b.practitioner_id} style={{ borderBottom: isLightMode ? '1px solid #F1F5F9' : '1px solid rgba(255,255,255,0.04)' }}>
                                        ...
                                        <td style={{ padding: '0.6rem 0.75rem', textAlign: 'center', fontWeight: 700, color: textSecondary }}>RM {fmt(b.syarikat_dapat ?? 0)}</td>
                                      </tr>
                                    ))}
                                    {/* Total row */}
                                    <tr style={{ borderTop: isLightMode ? '2px solid #E2E8F0' : '2px solid rgba(255,255,255,0.1)', background: isLightMode ? '#F1F5F9' : 'rgba(255,255,255,0.03)', fontWeight: 800 }}>
                                      ...
                                      <td style={{ padding: '0.6rem 0.75rem', textAlign: 'center', color: textSecondary }}>RM {fmt(rec.breakdown.reduce((s, b) => s + (b.syarikat_dapat ?? 0), 0))}</td>
                                    </tr>
                                  </tbody>
                                </table>
