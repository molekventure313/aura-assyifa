...
export default function Home() {
  ...
  return (
    <main className="salespage-mvsyifaa-layout">
      <HeroSection />
      <TestimonialSection />
      <ProblemSection />
      <ProcessSection />
      ...
      <footer style={{ background: 'var(--turquoise-dark)', color: '#fff', padding: '1.75rem 1rem', textAlign: 'center', fontSize: '0.85rem' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <p style={{ margin: '0 0 0.5rem 0', fontWeight: 700, fontSize: '1rem', color: 'var(--yellow-accent)' }}>
            🌿 MV SYIFAA' · Rawatan Jarak Jauh Gangguan Jin, Sihir, Santau &amp; Saka
          </p>
          <p style={{ margin: 0, opacity: 0.85, fontSize: '0.8rem' }}>
            © {new Date().getFullYear()} MV SYIFAA'. Hak cipta terpelihara. Rawatan berasaskan bacaan Al-Quran dan doa berlandaskan syarak.
          </p>
        </div>
      </footer>
    </main>
