...
const LAYERS = [
  ...
  { num: 'II', accent: '#F59E0B', title: 'Ayat Khusus Pembatal & Pemutusan Ikatan Saka', desc: 'Memutuskan dan membatalkan setiap ikatan saka turun-temurun yang aktif — dari punca asal keturunan hingga ke generasi semasa.' },
  ...
  { num: 'IV', accent: '#34D399', title: 'Ayat-Ayat Kesembuhan & Pemulihan Jiwa', desc: 'Memulihkan kesan-kesan saka yang masih tinggal dalam badan, jiwa dan kehidupan — membantu proses penyembuhan dan pembukaan rezeki secara berterusan.' },
];
    ...
    <main style={{ minHeight: '100vh', background: '#042E23', fontFamily: "'Inter', -apple-system, sans-serif", color: '#FFF' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, #010E09 0%, #021812 50%, #042E23 100%)', padding: '5rem 1rem 4rem', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative', animation: 'fadeInUp 0.8s ease both' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(253,224,71,0.1)', border: '1px solid rgba(253,224,71,0.4)', padding: '0.4rem 1.2rem', borderRadius: '50px', marginBottom: '1.5rem', fontSize: '0.75rem', fontWeight: 800, color: '#FDE047', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
            Aura Assyifa · Pengisian Khusus Kes Saka
          </div>
          ...
          <h1 className="hero-h1" style={{ fontSize: 'clamp(1.9rem, 4.5vw, 3rem)', fontWeight: 900, color: '#FEF3C7', lineHeight: 1.18, letterSpacing: '-0.03em', marginBottom: '1.25rem' }}>
            Jangan Biarkan Saka Terus Membebankan{' '}
            <span style={{ color: '#FDE047', textShadow: '0 0 30px rgba(253,224,71,0.3)' }}>Generasi Demi Generasi</span>
          </h1>
          ...
          <p style={{ fontSize: '1.05rem', color: '#A7F3D0', lineHeight: 1.75, maxWidth: '640px', margin: '0 auto 1.75rem' }}>
            ...
            <strong style={{ color: '#FEF3C7' }}>Ia tidak akan hilang sendiri tanpa tindakan yang betul.</strong>
          </p>
          ...
          <div style={{ backdropFilter: 'blur(12px)', background: 'rgba(253,224,71,0.05)', border: '1.5px solid rgba(253,224,71,0.25)', borderRadius: '20px', padding: '1.5rem 2rem', maxWidth: '620px', margin: '0 auto 2rem', textAlign: 'left', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
            <div style={{ fontSize: '0.7rem', fontWeight: 800, color: '#FDE047', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '0.9rem' }}>Tanda-Tanda Anda Mungkin Terkena Saka</div>
          ...
          <div style={{ width: '140px', height: '140px', borderRadius: '50%', background: 'radial-gradient(circle at 35% 35%, #065F46, #010E09)', border: '2px solid rgba(253,224,71,0.6)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '0 auto 2.5rem', animation: 'pulseGlow 3s ease-in-out infinite', boxShadow: '0 0 0 8px rgba(253,224,71,0.05)' }}>
            ...
            <span style={{ fontSize: '0.5rem', color: '#FDE047', fontWeight: 800, letterSpacing: '0.06em', textAlign: 'center', lineHeight: 1.4 }}>PENGISIAN<br />PEMUSNAH<br />SAKA</span>
          </div>
      ...
      <section style={{ background: '#042E23', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          <span style={{ display: 'inline-block', fontSize: '0.72rem', fontWeight: 800, color: '#FDE047', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem', background: 'rgba(253,224,71,0.1)', padding: '0.3rem 1rem', borderRadius: '50px', border: '1px solid rgba(253,224,71,0.3)' }}>Tanda-Tanda Saka</span>
          ...
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>
            Gangguan saka sering tidak disedari kerana ia berlaku secara turun-temurun.{' '}
            <strong style={{ color: '#FDE047' }}>Jika anda mengalami lebih dari 3 perkara ini</strong> — ikatan saka mungkin masih aktif dalam keluarga anda.
          </p>
      ...
      <section style={{ background: 'linear-gradient(160deg, #0B1A0F 0%, #031208 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Kenapa Mangsa Saka Perlu Pengisian — Bukan Sekadar Rawatan Biasa?</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>
            Rawatan biasa mungkin melegakan gejala untuk sementara. Tapi tanpa perlindungan berterusan —{' '}
            <strong style={{ color: '#FDE047' }}>ikatan saka akan terus aktif dan berpindah kepada generasi berikutnya.</strong>
          </p>
      ...
      <section style={{ background: '#042E23', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Rawatan Saka Melalui Al-Quran — Perintah &amp; Janji Allah</h2>
      ...
      <section style={{ background: '#F8FAFC', color: '#0F172A', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#042E23', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Apa Yang Ingin Dicapai Melalui Pengisian Pemusnah Saka Aura Assyifa?</h2>
          <p style={{ fontSize: '1rem', color: '#4B5563', lineHeight: 1.65, marginBottom: '2.5rem' }}>Pengisian ini dirangka khusus untuk memutuskan ikatan saka turun-temurun secara tuntas dan patuh syariah.</p>
      ...
      <section style={{ background: '#031E17', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>4 Lapisan Ayat Ruqyah Khusus Kes Saka</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.7, maxWidth: '680px', margin: '0 auto 2.5rem', opacity: 0.9 }}>Setiap barang diisi dengan 4 lapisan ayat ruqyah syar&apos;iyyah yang berbeza fungsi — direka khusus untuk memutuskan ikatan saka turun-temurun dan melindungi seluruh keluarga.</p>
          ...
          <div style={{ background: 'linear-gradient(135deg, #065F46 0%, #047857 100%)', border: '2px solid rgba(16,185,129,0.4)', borderRadius: '18px', padding: '1.75rem', display: 'flex', alignItems: 'flex-start', gap: '1.25rem', textAlign: 'left' }} className="anim-card">
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#D1FAE5', fontSize: '0.92rem', lineHeight: 1.7 }}>Perawat Aura Assyifa akan buat <strong style={{ color: '#FDE047' }}>pelarasan dan pengisian semula setiap minggu secara automatik</strong> — memastikan kekuatan ayat ruqyah pada barang anda sentiasa pada kapasiti penuh untuk lindungi seluruh keluarga.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#0B382D', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '980px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.5rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Betulkah Aura Assyifa Berkesan Untuk Selesaikan Gangguan Saka?</h2>
      ...
      <section id="borang" style={{ background: 'linear-gradient(160deg, #042E23 0%, #021812 100%)', padding: '4.5rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }} className="anim-section">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.2rem)', fontWeight: 800, color: '#FDE047', marginTop: '0.5rem', marginBottom: '0.75rem', letterSpacing: '-0.02em', lineHeight: 1.25 }}>Dapatkan Pengisian Pemusnah Saka Aura Assyifa</h2>
          <p style={{ fontSize: '1rem', color: '#D1FAE5', lineHeight: 1.65, maxWidth: '560px', margin: '0 auto 2rem', opacity: 0.9 }}>Satu pelaburan untuk memutuskan ikatan saka seumur hidup. Pelarasan mingguan percuma selama-lamanya.</p>
          ...
          <div style={{ background: 'linear-gradient(160deg, #031E17 0%, #042E23 100%)', border: '2px solid rgba(253,224,71,0.4)', borderRadius: '24px', padding: '2.5rem 2rem', marginBottom: '2rem', boxShadow: '0 24px 60px rgba(0,0,0,0.5), 0 0 60px rgba(253,224,71,0.06)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ fontSize: '0.72rem', fontWeight: 800, color: '#FDE047', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.75rem' }}>Pengisian Pemusnah Saka Aura Assyifa</div>
            ...
            <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
              {[
                ...
                '4 lapisan ayat ruqyah khusus kes saka',
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            {[
              { q: 'Adakah ini untuk kes saka sahaja?', a: 'Pengisian Pemusnah Saka ini dirangka khusus dengan 4 lapisan ayat yang ditujukan untuk memutuskan ikatan saka turun-temurun. Namun ia juga membantu gangguan jin yang berkait dengan saka.' },
              ...
              { q: 'Bolehkah satu barang melindungi seluruh keluarga?', a: 'Barang berisian boleh digunakan untuk buat air penawar untuk seluruh ahli keluarga. Panduan lengkap akan diberikan selepas tempahan.' },
